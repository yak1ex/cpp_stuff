...
// Modified by Yak! to pass an additional prefix parameter on construction
...
namespace boostex 
{
    ...
    namespace detail
    {
        template< typename T, class MostDerived, typename Function, typename FunctionConst, 
            int Arity, int MinArity >
        struct forward_adapter_impl_;

        struct forward_adapter_result_
        {
...
#   define BOOST_TMP_MACRO(f,fn,fc) \
        ...
        , private Function
    {
      ...
      public:
        ...
        T& target_arg() { return t; }

        template< typename Sig > struct result
            : detail::forward_adapter_result_::template apply<Sig>
        { };

        using BOOST_TMP_MACRO(Function,Function, Function const)::operator();
    };
    template< typename T, typename Function, int Arity_Or_MinArity, int MaxArity >
    class forward_adapter_< T, Function const, Arity_Or_MinArity, MaxArity >
    ...
    template< typename T, typename Function, int Arity_Or_MinArity, int MaxArity >
    class forward_adapter_< T, Function &, Arity_Or_MinArity, MaxArity >
        : public BOOST_TMP_MACRO(Function&, Function, Function)
    {
        T& t;
        Function& ref_function;
      public:
        forward_adapter_(T& t, Function& f)
          : t(t), ref_function(f) 
        { }
    ...
    {
        template< class Self >
        struct forward_adapter_result_::apply< Self() >
            : ::boost::result_of< BOOST_DEDUCED_TYPENAME c<Self>::t() >
        { };

        template< typename T, class MD, class F, class FC >
        struct forward_adapter_impl_<T,MD,F,FC,0,0>
        {
            inline typename ::boost::result_of< FC(T&) >::type
            operator()() const
            {
                return static_cast<MD const*>(this)->target_function()(static_cast<MD const*>(this)->target_arg());
            }

            inline typename ::boost::result_of< F(T&) >::type
            operator()()
            {
                return static_cast<MD*>(this)->target_function()(static_cast<MD*>(this)->target_arg());
            }
...
#       define BOOST_TMP_MACRO(tpl_params,arg_types,params,args)              \
            template< tpl_params >                                             \
            inline typename ::boost::result_of< FC(T&, arg_types) >::type            \
            operator()(params) const                                           \
            {                                                                  \
                return static_cast<MD const*>(this)->target_function()(static_cast<MD const*>(this)->target_arg(), args);  \
            }                                                                  \
            template< tpl_params >                                             \
            inline typename ::boost::result_of< F(T&, arg_types)>::type              \
            operator()(params)                                                 \
            {                                                                  \
                return static_cast<MD*>(this)->target_function()(static_cast<MD*>(this)->target_arg(), args);        \
            }
...
#       define  BOOST_PP_FILENAME_1 "forward_adapter_.hpp"
...
#     define  BOOST_PP_FILENAME_3 "forward_adapter_.hpp"
...
#         endif
        ...
        struct forward_adapter_result_::apply< Self(BOOST_PP_ENUM_PARAMS(N,T)) >
            : ::boost::result_of< 
        ...
        template< typename T, class MD, class F, class FC >
        struct forward_adapter_impl_<T,MD,F,FC,BOOST_PP_DEC(N),N>
        {
            template< BOOST_PP_ENUM_PARAMS(N,typename T) >
            inline typename ::boost::result_of< F(T&,
                BOOST_PP_ENUM_BINARY_PARAMS(N,T,& BOOST_PP_INTERCEPT)) >::type
            operator()(BOOST_PP_ENUM_BINARY_PARAMS(N,T,& BOOST_PP_INTERCEPT));
        };

        template< typename T, class MD, class F, class FC, int MinArity >
        struct forward_adapter_impl_<T,MD,F,FC,N,MinArity>
            : forward_adapter_impl_<T,MD,F,FC,BOOST_PP_DEC(N),MinArity>
        {
            using forward_adapter_impl_<T,MD,F,FC,BOOST_PP_DEC(N),MinArity>::operator();
...
#       if BOOST_WORKAROUND(BOOST_MSVC,BOOST_TESTED_AT(1400)) 
            ...
            inline typename boost::result_of<  FC(T&, BOOST_PP_ENUM_PARAMS(N,PT)) 
                >::type
            operator()(BOOST_PP_ENUM_BINARY_PARAMS(N,PT,a)) const
            {
                return static_cast<MD const* const>(this)
                    ->target_function()(static_cast<MD const* const>(this)
                    ->target_arg(), BOOST_PP_ENUM_PARAMS(N,a));
            }
            template< typename T, BOOST_PP_ENUM_PARAMS(N,typename T) >
            inline typename boost::result_of<  F(T&, BOOST_PP_ENUM_PARAMS(N,PT))
                >::type
            operator()(BOOST_PP_ENUM_BINARY_PARAMS(N,PT,a))
            {
                return static_cast<MD* const>(this)
                    ->target_function()(static_cast<MD* const>(this)
                    ->target_arg(), BOOST_PP_ENUM_PARAMS(N,a));
            }
#       else
